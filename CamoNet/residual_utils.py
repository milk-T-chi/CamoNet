...
#     while in_size / downsample_ratio < kernel_size:
#         kernel_size -= 2
#     output = Model.SiameseResidual(in_channels=in_channels,
...
def insert_residual(input, x):
    ...
    output = Model.SiameseResidual(in_channels=in_channels,
                                   ...
                                   out_size=out_size, kernel_size=kernel_size,
                                   downsample_ratio=downsample_ratio,
                                   channel_reduce_ratio=channel_reduce_ratio)(input, training=True)
