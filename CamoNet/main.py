...
parser.add_argument('--dataset_name', type=str, default="tf_flowers")  #
parser.add_argument('--data_root_path', type=str, default="/extern1/zzy/IMG_Split/Split_Data/")
parser.add_argument('--unlabeled_dataset_rate', type=float, default=0.99)  #
parser.add_argument("--image_size", type=int, default=224)  #
parser.add_argument("--image_channels", type=int, default=3)
parser.add_argument("--batch_size", type=int, default=32)  #
parser.add_argument("--num_class", type=int, default=5)  #
parser.add_argument("--total_data", type=int, default=2752)  #
...
parser.add_argument('--contrastive_epoch', type=int, default=300)  #
...
parser.add_argument('--load_weights_path', type=str, default="./save_weights/tf_flowers/NUC/contrastive.ckpt")  #
parser.add_argument('--save_weights_path', type=str, default="./save_weights/tf_flowers/NUC/contrastive.ckpt")  #
# Options: contrastive, supervised_Last, supervised_Residual, supervised_All
parser.add_argument('--training_mode', type=str, default="contrastive + supervised_Residual")  #
...
contrastive_model = LiteSiameseModel(encoder=encoder, backbone=None)
...
ft_model = LiteSiameseModel(encoder=tf.keras.Model(inputs, outputs), backbone=None)
